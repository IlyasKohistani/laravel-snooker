...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12">
      <form class="form-inline" action="{{ route('report.staffData') }}" method="POST">
        @csrf
        <div class="form-group">
          <label for="date">Year</label>
          <select class="form-control" name="select_year" onchange="this.form.submit()" id="select_year">
        ...
        <div class="form-group">
          ...
          <select class="form-control" onchange="this.form.submit()" name="select_store" id="select_store">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="select_user" id="select_user">
            ...
            <option value="{{ $v['id'] }}" @if($selected_user==$v['id']) selected="selected" @endif>{{ $v['username'] }}
            </option>
            @endforeach
          </select>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      $("#staffReportSubMenu").addClass('active');
