          ...
          <table id="manageTable" class="table table-bordered table-striped" style="width: 100%">
            <thead>
              <tr>
                <th>Category name</th>
                <th>Status</th>
                @if(in_array('updateCategory', $user_permission) || in_array('deleteCategory', $user_permission))
                <th>Action</th>
                @endif
              </tr>
            </thead>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="{{ route('category.store') }}" method="post" id="createForm">
        @csrf
...
@if(in_array('updateCategory', $user_permission))
<!-- edit brand modal -->
...
@if(in_array('deleteCategory', $user_permission))
<!-- remove brand modal -->
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + "{{ route('category.data') }}",
    'order': []
  });
